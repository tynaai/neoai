/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 3623f4ec35d52f9b1f30759cd648ac6b)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	BETTER_AUTH_URL: "https://neoai-api.tynaai.tech" | "https://neoai-api.02017883.workers.dev";
	CORS_ORIGIN: "https://neoai.tynaai.tech" | "https://neoai-web.02017883.workers.dev";
	BETTER_AUTH_SECRET: string;
	DATABASE_URL: string;
	OPENAI_API_KEY: string;
	MASTRA_PLATFORM_ACCESS_TOKEN: string;
	MASTRA_PROJECT_ID: string;
	WEB: Fetcher /* neoai-web-production */ | Fetcher /* neoai-web */;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		MASTRA_PLATFORM_ACCESS_TOKEN: string;
		MASTRA_PROJECT_ID: string;
		WEB: Fetcher /* neoai-web-production */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "CORS_ORIGIN" | "BETTER_AUTH_SECRET" | "DATABASE_URL" | "OPENAI_API_KEY" | "MASTRA_PLATFORM_ACCESS_TOKEN" | "MASTRA_PROJECT_ID">> {}
}
