/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../web/wrangler.jsonc --env-interface=CloudflareBindings` (hash: 616cc826757a2a0ea92aeb25470f8c8e)
// Runtime types generated with workerd@1.20260710.1 2026-07-16 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	BETTER_AUTH_URL: "https://neoai-api.tynaai.tech" | "http://localhost:8787";
	CORS_ORIGIN: "https://neoai.tynaai.tech" | "http://localhost:5173";
	BETTER_AUTH_SECRET: string;
	DATABASE_URL: string;
	WEB: Service<typeof import("../../node_modules/.pnpm/wrangler@4.111.0_@cloudflare+workers-types@5.20260716.1/node_modules/wrangler/templates/no-op-worker").default>;
}
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		BETTER_AUTH_URL: "https://neoai-api.tynaai.tech";
		CORS_ORIGIN: "https://neoai.tynaai.tech";
		BETTER_AUTH_SECRET: string;
		DATABASE_URL: string;
		WEB: Service<typeof import("../../node_modules/.pnpm/wrangler@4.111.0_@cloudflare+workers-types@5.20260716.1/node_modules/wrangler/templates/no-op-worker").default>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "CORS_ORIGIN" | "BETTER_AUTH_SECRET" | "DATABASE_URL">> {}
}
